...
public interface BookMarkRepository extends JpaRepository<BookMark, Long> {
    ...
    @Query(value = "FROM BookMark b WHERE b.trainer.trainerId = :trainerId AND b.user.id = :userId")
    Optional<BookMark> findByTrainerIdAndUserId(Long trainerId, String userId);
